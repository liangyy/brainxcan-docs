...
First of all, please make sure you've cloned [Brainxcan code repository](https://github.com/liangyy/brainxcan) and installed all the BrainXcan software dependencies. 

To perform BrainXcan analysis, we need to prepare the following files:

* The BrainXcan database and meta files (download from [brainxcan.hakyimlab.org](brainxcan.hakyimlab.org))
...
The BrainXcan database and meta files can be downloaded from [brainxcan.hakyimlab.org](brainxcan.hakyimlab.org).
...
It is implemented using `snakemake` @molder2021sustainable and the features provided by `snakemake` is directly applicable here. 
